...
<h2>Flesh out the Adventure</h2>
    ...
    <div class="createAdventureNotesSection">
        <h4>The Quest</h4>
        <textarea bind:value={$currentAdventure.notes.quest} class="createAdventureTextArea brutalismBorder" placeholder="Detail the hook and context of the adventure. Why is the party doing this? What parties are involved?" rows="6"/>
    </div>
    <div class="createAdventureNotesSection">
        <h4>The NPC</h4>
