...
let sourceTemplates = [
    ...
    [
      ...
      [
        ...
        [["C", "NE", "SW"], ["C", "NW", "SE"], ["R", "NE", "SW", "NW", "SE"], ["C", "NW", "SW"]],
      ...
      [
        ...
        [["R", "NE"], ["C", "NW", "SE"], ["R", "NE", "SW"], ["C", "NW", "SE"], ["R", "SW", "SE"]],
        [["-"], ["C", "NW", "NE", "SW", "SE"], ["-"], ["C", "NE", "NW"], ["R", "NW"]],
        [["-"], ["R", "NE", "SW"], ["D", "NW", "SE"], ["-"], ["-"]],
        [["D", "NE", "SE"], ["-"], ["C","NW", "SE"], ["-"], ["-"]],
        [["-"], ["C", "NW", "SE"], ["-"], ["R", "NW"], ["-"]],
        [["-"], ["C", "NW", "SW"], ["-"], ["-"], ["-"]],
      ...
      [
        [["-"], ["R", "SW", "SE"], ["-"], ["R", "SW", "SE"], ["-"]],
        [["R", "NE", "SW", "SE"], ["C", "NW", "SE"], ["C", "NE", "SW"], ["R", "NW", "SW", "SE"], ["-"]],
        [["R", "NE"], ["D", "NW", "SE"], ["D", "NE", "NW"], ["D", "NE", "SW"], ["R", "NW"]],
        [["-"], ["C", "NW", "SE"], ["C", "NE", "SW"], ["-"], ["-"]],
        [["-"], ["-"], ["D", "NW", "NE", "SW", "SE"], ["-"], ["-"]],
        [["-"], ["D", "NE", "SW"], ["D", "NW", "SE"], ["-"], ["-"]],
        [["-"], ["C", "NE", "SW"], ["-"], ["C", "NW", "SE"], ["-"]],
      ...
      [
        [["-"], ["R", "SE"], ["R", "SW"], ["-"], ["-"], ["-"], ["-"]],   
        [["-"], ["R", "NE", "NW", "SE"], ["R", "SE", "SW"], ["-"], ["-"], ["-"], ["-"]],   
        [["-"], ["-"], ["R", "NE", "NW", "SE", "SW"], ["R", "NW", "SW", "SE"], ["-"], ["-"], ["-"]],   
        [["-"], ["R", "NE", "SE", "SW"], ["R", "NE", "SE", "NW"], ["R", "NW"], ["-"], ["-"], ["-"]],
        [["-"], ["D", "NE", "SW"], ["R", "NE", "NW"], ["-"], ["-"], ["-"], ["-"]],
        [["D", "NE", "SE"], ["-"], ["-"], ["-"], ["-"], ["-"], ["-"]],
        [["-"], ["R", "NW", "SE"], ["-"], ["-"], ["-"], ["-"], ["-"]],
        [["-"], ["R", "NW", "SW"], ["-"], ["-"], ["-"], ["-"], ["-"]],
...
let temporaryTemplates = sourceTemplates.map(template => template.map(tile => tile.slice(0)));
...
function returnTileOptions(connectedDirectionsArray, correctTileTypeArray) {
    ...
    (connectedDirectionsArray.includes("NW") ? directionChecker.push(true) : directionChecker.push(false)); 
    (connectedDirectionsArray.includes("NE") ? directionChecker.push(true) : directionChecker.push(false));
    (connectedDirectionsArray.includes("SE") ? directionChecker.push(true) : directionChecker.push(false));
    (connectedDirectionsArray.includes("SW") ? directionChecker.push(true) : directionChecker.push(false));
    ...
    correctTileTypeArray.filter(tile => {
        ...
        if (JSON.stringify(directionChecker) === JSON.stringify(potentialTileDirectionChecker)) {
...
function returnMapArray(template) {
    for (let i = 0; i < template.length; i++) {
        for (let j = 0; j < template[i].length; j++) {
            ...
            let tileOptions = returnTileOptions(connectedDirections, correctTileTypeArray);
